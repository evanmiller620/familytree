const familyData = [
    ...
    { id: 16, name: "Kwan", birthDate: '?', spouseId: 13, parentIds: [], generation: 1 },
    ...
    {id: 7, name: 'Terri', birthDate: '29', spouseId: 29, parentIds: [11, 12], generation: 2},
    ...
    {id: 29, name: 'Ralph', birthDate: '?', spouseId: 7, parentIds: [], generation: 2},
